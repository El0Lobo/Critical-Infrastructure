// lowpoly-bg.js
window.lowpolyInstance = null;

window.stopLowpoly = function () {
  if (window.lowpolyInstance && typeof window.lowpolyInstance.remove === "function") {
    window.lowpolyInstance.remove();
    window.lowpolyInstance = null;
  }
};
...
window.runLowpoly = function() {
  ...
  function boot(){
    ...
    window.lowpolyInstance = new window.p5(sketch);
  }
};
